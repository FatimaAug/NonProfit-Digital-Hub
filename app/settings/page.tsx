...
import { clearAppState } from "@/lib/storage";
          ...
          <CardContent className="space-y-4">
            <div className="p-4 bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-900/50 rounded-lg">
              <div className="flex gap-2">
                ...
                <div className="text-sm text-blue-900 dark:text-blue-300">
                  All your data is stored locally in your browser. Regular
            ...
            <div>
              ...
              <p className="text-sm text-muted-foreground mb-3">
                Download a backup of all your data as a JSON file. You can use
                this to restore your data later.
              </p>
              <Button
        ...
        <Card>
          ...
          <CardContent className="space-y-3 text-sm">
            <div className="flex justify-between">
              ...
              <span className="font-medium">Digital Empowerment Hub</span>
            </div>
            <div className="flex justify-between">
