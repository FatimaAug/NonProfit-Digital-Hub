    ...
    <div className="pt-12">
      ...
      <div className="px-6 lg:px-8 py-8 border-b border-border bg-card">
        ...
        <p className="text-muted-foreground mt-2">
          Assess your current communication practices and identify improvement
          areas
        </p>
      </div>
      ...
      <div className="px-6 lg:px-8 py-8 space-y-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          <Card>
            ...
            <CardContent>
              <div
                className={`text-4xl font-bold ${getScoreColor(auditScore)}`}
              >
                {auditScore}%
              </div>
                    ...
                    {items.map((item) => (
                      ...
                      >
                        ...
                        <div className="flex gap-2">
                          ...
                          <button
                            onClick={() =>
                              handleStatusChange(item.id, "partial")
                            }
                            className={`px-4 py-2 rounded-lg text-sm font-medium transition-colors ${
                              item.status === "partial"
